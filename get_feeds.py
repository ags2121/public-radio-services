    ...
    class Worker(Thread):
        ...
        def run(self):
            while True:
                ...
                feed = feed.get("fetcher_override")(feed) if feed.get("fetcher_override") else default_fetcher(feed)
...
def perform_web_requests(num_workers: int):
    ...
    return _perform_web_requests(feeds=newscasts, num_workers=num_workers)
